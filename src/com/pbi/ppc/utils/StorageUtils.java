...
public class StorageUtils
{
    ...
    private static final int FREE_SIZE = 10; //M
    ...
    public int checkHDDSpace()
    {
        ...
        try
        {
            ...
            if (null != bean)
            {
                ...
                Log.i(TAG, "--->>>check the external device free size is: " + freeSize);
    ...
    private int getPathType(String path)
    {
        ...
        else if (path.contains("/storage/external_storage/sdcard"))
        {
            return (2);
        }
        else if (!path.contains("/storage/external_storage/sdcard") && path.contains("/storage/external_storage/sd"))
        {
            return (1);
        }
        // other devices.
